...
public class Dua3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        diem=20;
        //ánh xạ
        cbx1 =  findViewById(R.id.bcheckBox1);
        cbx2 =  findViewById(R.id.bcheckBox2);
        cbx3=findViewById(R.id.bcheckBox3);
        btnChoi =  findViewById(R.id.bbtnChoi);
        btnThoat =  findViewById(R.id.bbtnThoat);

        tvkq =  findViewById(R.id.btvketqua);
        tvDiem =  findViewById(R.id.bbtvDiem);
        seekBar1 =  findViewById(R.id.bseekBar1);
        seekBar2 =  findViewById(R.id.bseekBar2);
        seekBar3 =  findViewById(R.id.bseekBar3);
...
//                    đường đua 1 win
                    ...
                    if((cbx1.isChecked() == true)){
                        Toast.makeText(Dua3.this, "Bạn đã thắng", Toast.LENGTH_SHORT).show();
                        diem+=10; //cộng điểm cho người chơi
                    }else{
                        Toast.makeText(Dua3.this, "Bạn đã thua", Toast.LENGTH_SHORT).show();
...
//                TODO:  chưa kiểm tra điểm người chơi còn hay không
                ...
                if(diem<= 0){
                    Toast.makeText(Dua3.this, "Bạn đã hết điểm", Toast.LENGTH_SHORT).show();
                }else{
...
//                xét trường hợp nếu cả 2 không được chọn, nghĩa là chưa chọn bất cứ  1 đường đua nào
                    if((cbx1.isChecked() == false) &&(cbx2.isChecked() == false) &&(cbx3.isChecked() == false)){
                        Toast.makeText(Dua3.this, "Hãy chọn 1 đường đua để bắt đầu", Toast.LENGTH_SHORT).show();
                    }else{
                        // nếu đã chọn, chỉ được chọn 1,
                        //Trường hợp cả 2 được chọn
                        if((cbx1.isChecked() == true) &&(cbx2.isChecked() == true)   ){
                            Toast.makeText(Dua3.this, "Chỉ được chọn 1 đường đua", Toast.LENGTH_SHORT).show();
                        }else{
//                        TODO: xử lý chơi
